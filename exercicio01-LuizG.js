...
console.log("Bem vindo ao banco", banco, "( Agência", agencia, ")");
console.log("Bom te ver de volta,", nome, "!");
...
console.log("Você enviou um Pix de R$12 para Carro do ovo.");
console.log("Saldo atual: R$", (saldo -= 12));

console.log("");
console.log("");
console.log("");

console.log("Pix recebido de Lóide no valor de R$12.");
console.log("Saldo atual: R$", (saldo += 12));
